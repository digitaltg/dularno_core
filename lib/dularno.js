...
class Kernel {
    ...
    constructor(entry, options) {
        ...
        this.controllerFunctionWhiteList = ["postInit"];
    }
    ...
    #loadService(module, key, clazz, deps, args) {
        ...
        if (deps == null) {
            ...
            this.container.services[module.name][key] = new clazz(
                depsInstances,
                // TODO: before we use spread array now we wille use the array
                ...args
            );
        ...
        if (typeof this.container.services[module.name][key].postInit === "function") {
            this.container.services[module.name][key].postInit();
            console.log(`DULARNO: Service ${key} postInit is called`);
        } else {
            console.log(`DULARNO: Service ${key} has no postInit`);
        }
    }
